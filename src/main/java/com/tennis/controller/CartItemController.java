...
public class CartItemController {
	...
	public ResponseEntity<Void> updateQuantity(@PathVariable Long productId, @RequestBody CartItemRequest request) {
		cartItemService.updateQuantity(productId, request.getQuantity());
